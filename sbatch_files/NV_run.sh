...
EXPERIENT_NAME=cap_max_8M_opacityREG0_scaleLR001_opacityLR005_posLR2e3_posLRfinal2e5_densifyFrom500Final100kIter100_frames12000
...
torchrun --standalone --nnodes=1 --nproc_per_node ${GPU_NUM} train.py --bsz ${GPU_NUM} \
            -s /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/data/long_video_processed_frames12000 \
            -m /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/models/long_video_frames12000  \
            --iterations $ITER  \
