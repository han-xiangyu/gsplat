...
#MODE="difix"
MODE=""
JOB_BASE_NAME=$(basename "$0" .sh)
LOG_BASE_PREFIX="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log_poseopt"
...
for i in {1..3}; do
    submit_job --gpu 8 --cpu 16 --nodes 1 \
        ...
        --notimestamp \
        --exclusive \
        --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/pose_opt/poseopt_lr1e3_decay1e3.sh $MODE"
done
