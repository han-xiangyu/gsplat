...
SOURCE_PATH="${BASE_DIR}/data/tra${TRAVERSAL_ID}_${NUM_KEYFRAMES}keyframes_${DOWNSAMPLE_TYPE}_${NUM_CAMS}cam_with_newviews"
MODEL_PATH="${BASE_DIR}/models/tra${TRAVERSAL_ID}_${NUM_KEYFRAMES}keyframes_${DOWNSAMPLE_TYPE}_${NUM_CAMS}cam_with_newviews"
