...
JOB_BASE_NAME="tra2_3000to7000_3cam_1node"
...
for i in {1..5}; do
    submit_job --gpu 8 --cpu 16 --nodes 1 \
        ...
        --notimestamp \
        --exclusive \
        --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_block/NV_train_b3000-7000.sh $MODE"
done
