...
MODEL_PATH="${BASE_DIR}/models_block_merge/${BASE_PATH_NAME}${PATH_SUFFIX}_visible_adam_radius_clip_1_farplane_400_4node"
...
torchrun --nproc_per_node=8 \
     ...
     examples/simple_trainer_origin_knn_plane.py mcmc  \
