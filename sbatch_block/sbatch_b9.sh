job_name="tra2_17000to20000_3cam"
base_logdir="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log_block/tra2_17000to20000_3cam"
...
for i in {6..7}; do
    submit_job --gpu 8 --cpu 16 --nodes 1 \
        ...
        --notimestamp \
        --exclusive \
        --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_block/NV_train_b9.sh"
done
