...
JOB_BASE_NAME="1node_8gpulr_citygs_wsadams"
...
submit_job --gpu 8 --cpu 16 --nodes 1 \
    ...
    --notimestamp \
    --exclusive \
    --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_nv/mnode/1node_lr8copy2.sh $MODE"
