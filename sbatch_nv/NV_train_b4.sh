...
SOURCE_PATH="${BASE_DIR}/data/tra${TRAVERSAL_ID}_9000to12000keyframes_${DOWNSAMPLE_TYPE}_${NUM_CAMS}cam"
MODEL_PATH="${BASE_DIR}/models/tra${TRAVERSAL_ID}_9000to12000keyframes_${DOWNSAMPLE_TYPE}_${NUM_CAMS}cam"
