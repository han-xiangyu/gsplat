job_name="tra2_6000to9000keyframes_fps_3cam"
base_logdir="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log/tra2_6000to9000keyframes_fps_3cam"
...
for i in {1..5}; do
    submit_job --gpu 8 --cpu 16 --nodes 1 \
        ...
        --notimestamp \
        --exclusive \
        --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_nv/NV_train_b3.sh"
done
