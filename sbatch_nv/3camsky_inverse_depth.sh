...
JOB_BASE_NAME="131sky_ground_inverse_depth"
...
for i in {1..4}; do
    submit_job --gpu 8 --cpu 16 --nodes 1 \
        ...
        --notimestamp \
        --exclusive \
        --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/projects/citygs/code/gsplat/nv_train/3cam_sky_inverse_depth.sh $MODE"
done
