job_name="gsplat_1node_1gpu"
base_logdir="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log/gsplat_1node_1gpu"
...
submit_job --gpu 1 --cpu 16 --nodes 1 \
    ...
    --logdir ${base_logdir} \
    --exclusive \
    --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/projects/gsplat-city/sbatch_nv/NV_train_origin_1node_1gpu.sh"
