job_name="tra2_3000keyframes_fps8w_3cam_gpsnew"
base_logdir="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log/tra2_3000keyframes_fps8w_3cam_gpsnew"
...
for i in {1..5}; do
    ...
    --notimestamp \
    --exclusive \
    --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_nv/NV_train_b1_gpsnew.sh"
done
