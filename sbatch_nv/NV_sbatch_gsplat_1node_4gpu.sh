job_name="gsplat_3000frames_6cam"
base_logdir="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log/gsplat_3000frames_6cam_v2"
...
submit_job --gpu 8 --cpu 16 --nodes 1 \
    ...
    --notimestamp \
    --exclusive \
    --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_nv/NV_train_origin_1node_4gpu.sh"
