job_name="eval_dynamic_mask"
base_logdir="/lustre/fsw/portfolios/nvr/users/ymingli/datasets/citygs/log/eval_dynamic_mask"
...
submit_job --gpu 8 --cpu 16 --nodes 1 \
    ...
    --notimestamp \
    --exclusive \
    --command "bash /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/code/gsplat/sbatch_nv/NV_train_b1_dmask_eval.sh"
