...
SOURCE_PATH="${BASE_DIR}/data/tra${TRAVERSAL_ID}_0to3000keyframes_${DOWNSAMPLE_TYPE}_${NUM_CAMS}cam"
MODEL_PATH="${BASE_DIR}/modelsv2/tra${TRAVERSAL_ID}_0to3000keyframes_${DOWNSAMPLE_TYPE}_${NUM_CAMS}cam_poseopt_start0"
...
torchrun --standalone \
     --nproc_per_node=8 \
     --nnodes=1 \
     examples/simple_trainer_origin_knn_pose_opt_0.py mcmc  \
